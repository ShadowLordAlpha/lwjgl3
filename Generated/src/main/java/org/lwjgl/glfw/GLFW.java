...
public class GLFW {
	...
	public static long glfwCreateWindow(int width, int height, CharSequence title, long monitor, long share) {
		...
		MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
		try {
			ByteBuffer titleEncoded = memEncodeUTF8(title, true, stack);
	...
	public static void glfwSetClipboardString(long window, CharSequence string) {
		MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
		try {
			ByteBuffer stringEncoded = memEncodeUTF8(string, true, stack);
	...
	public static int glfwExtensionSupported(CharSequence extension) {
		MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
		try {
			ByteBuffer extensionEncoded = memEncodeASCII(extension, true, stack);
	...
	public static long glfwGetProcAddress(CharSequence procname) {
		MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
		try {
			ByteBuffer procnameEncoded = memEncodeASCII(procname, true, stack);

...
public class NativeFileDialog {
	...
	public static int NFD_OpenDialog(CharSequence filterList, CharSequence defaultPath, PointerBuffer outPath) {
		...
		try {
			ByteBuffer filterListEncoded = filterList == null ? null : memEncodeUTF8(filterList, true, stack);
			ByteBuffer defaultPathEncoded = defaultPath == null ? null : memEncodeUTF8(defaultPath, true, stack);

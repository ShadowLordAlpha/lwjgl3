...
public class CGL {
	...
	static boolean isAvailable(GLCapabilities caps) {
		return checkFunctions(
			caps.CGLGetCurrentContext, caps.CGLSetCurrentContext, caps.CGLGetShareGroup, caps.CGLChoosePixelFormat, caps.CGLDestroyPixelFormat, 
			caps.CGLDescribePixelFormat, caps.CGLReleasePixelFormat, caps.CGLRetainPixelFormat, caps.CGLGetPixelFormatRetainCount, caps.CGLQueryRendererInfo, 
			caps.CGLDestroyRendererInfo, caps.CGLDescribeRenderer, caps.CGLCreateContext, caps.CGLDestroyContext, caps.CGLCopyContext, caps.CGLRetainContext, 
			caps.CGLReleaseContext, caps.CGLGetContextRetainCount, caps.CGLGetPixelFormat, caps.CGLCreatePBuffer, caps.CGLDestroyPBuffer, 
			caps.CGLDescribePBuffer, caps.CGLTexImagePBuffer, caps.CGLRetainPBuffer, caps.CGLReleasePBuffer, caps.CGLGetPBufferRetainCount, 
			caps.CGLSetOffScreen, caps.CGLGetOffScreen, caps.CGLSetFullScreen, caps.CGLSetFullScreenOnDisplay, caps.CGLSetPBuffer, caps.CGLGetPBuffer, 
			caps.CGLClearDrawable, caps.CGLFlushDrawable, caps.CGLEnable, caps.CGLDisable, caps.CGLIsEnabled, caps.CGLSetParameter, caps.CGLGetParameter, 
			caps.CGLSetVirtualScreen, caps.CGLGetVirtualScreen, caps.CGLUpdateContext, caps.CGLSetGlobalOption, caps.CGLGetGlobalOption, caps.CGLLockContext, 
			caps.CGLUnlockContext, caps.CGLGetVersion, caps.CGLErrorString
		);
	}
	...
	public static long CGLGetCurrentContext() {
		long __functionAddress = GL.getCapabilities().CGLGetCurrentContext;
		if ( CHECKS )
	...
	public static int CGLSetCurrentContext(long context) {
		long __functionAddress = GL.getCapabilities().CGLSetCurrentContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
	...
	public static long CGLGetShareGroup(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLGetShareGroup;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLChoosePixelFormat(long attribs, long pix, long npix) {
		long __functionAddress = GL.getCapabilities().CGLChoosePixelFormat;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int CGLDestroyPixelFormat(long pix) {
		long __functionAddress = GL.getCapabilities().CGLDestroyPixelFormat;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
		}
	...
	public static int nCGLDescribePixelFormat(long pix, int pix_num, int attrib, long value) {
		long __functionAddress = GL.getCapabilities().CGLDescribePixelFormat;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
		}
	...
	public static void CGLReleasePixelFormat(long pix) {
		long __functionAddress = GL.getCapabilities().CGLReleasePixelFormat;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
		}
	...
	public static long CGLRetainPixelFormat(long pix) {
		long __functionAddress = GL.getCapabilities().CGLRetainPixelFormat;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
		}
	...
	public static int CGLGetPixelFormatRetainCount(long pix) {
		long __functionAddress = GL.getCapabilities().CGLGetPixelFormatRetainCount;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
		}
	...
	public static int nCGLQueryRendererInfo(int display_mask, long rend, long nrend) {
		long __functionAddress = GL.getCapabilities().CGLQueryRendererInfo;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int CGLDestroyRendererInfo(long rend) {
		long __functionAddress = GL.getCapabilities().CGLDestroyRendererInfo;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(rend);
		}
	...
	public static int nCGLDescribeRenderer(long rend, int rend_num, int prop, long value) {
		long __functionAddress = GL.getCapabilities().CGLDescribeRenderer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(rend);
		}
	...
	public static int nCGLCreateContext(long pix, long share, long ctx) {
		long __functionAddress = GL.getCapabilities().CGLCreateContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pix);
			checkPointer(share);
	...
	public static int CGLDestroyContext(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLDestroyContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLCopyContext(long src, long dst, int mask) {
		long __functionAddress = GL.getCapabilities().CGLCopyContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(src);
			checkPointer(dst);
	...
	public static long CGLRetainContext(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLRetainContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static void CGLReleaseContext(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLReleaseContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLGetContextRetainCount(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLGetContextRetainCount;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static long CGLGetPixelFormat(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLGetPixelFormat;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLCreatePBuffer(int width, int height, int target, int internalFormat, int max_level, long pbuffer) {
		long __functionAddress = GL.getCapabilities().CGLCreatePBuffer;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int CGLDestroyPBuffer(long pbuffer) {
		long __functionAddress = GL.getCapabilities().CGLDestroyPBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
	...
	public static int nCGLDescribePBuffer(long obj, long width, long height, long target, long internalFormat, long mipmap) {
		long __functionAddress = GL.getCapabilities().CGLDescribePBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(obj);
		}
	...
	public static int CGLTexImagePBuffer(long ctx, long pbuffer, int source) {
		long __functionAddress = GL.getCapabilities().CGLTexImagePBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
			checkPointer(pbuffer);
	...
	public static long CGLRetainPBuffer(long pbuffer) {
		long __functionAddress = GL.getCapabilities().CGLRetainPBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}
	...
	public static void CGLReleasePBuffer(long pbuffer) {
		long __functionAddress = GL.getCapabilities().CGLReleasePBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}
	...
	public static int CGLGetPBufferRetainCount(long pbuffer) {
		long __functionAddress = GL.getCapabilities().CGLGetPBufferRetainCount;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}
	...
	public static int nCGLSetOffScreen(long ctx, int width, int height, int rowbytes, long baseaddr) {
		long __functionAddress = GL.getCapabilities().CGLSetOffScreen;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLGetOffScreen(long ctx, long width, long height, long rowbytes, long baseaddr) {
		long __functionAddress = GL.getCapabilities().CGLGetOffScreen;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLSetFullScreen(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLSetFullScreen;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLSetFullScreenOnDisplay(long ctx, int display_mask) {
		long __functionAddress = GL.getCapabilities().CGLSetFullScreenOnDisplay;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLSetPBuffer(long ctx, long pbuffer, int face, int level, int screen) {
		long __functionAddress = GL.getCapabilities().CGLSetPBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
			checkPointer(pbuffer);
	...
	public static int nCGLGetPBuffer(long ctx, long pbuffer, long face, long level, long screen) {
		long __functionAddress = GL.getCapabilities().CGLGetPBuffer;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLClearDrawable(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLClearDrawable;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLFlushDrawable(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLFlushDrawable;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLEnable(long ctx, int pname) {
		long __functionAddress = GL.getCapabilities().CGLEnable;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLDisable(long ctx, int pname) {
		long __functionAddress = GL.getCapabilities().CGLDisable;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLIsEnabled(long ctx, int pname, long enable) {
		long __functionAddress = GL.getCapabilities().CGLIsEnabled;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLSetParameter(long ctx, int pname, long params) {
		long __functionAddress = GL.getCapabilities().CGLSetParameter;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLGetParameter(long ctx, int pname, long params) {
		long __functionAddress = GL.getCapabilities().CGLGetParameter;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLSetVirtualScreen(long ctx, int screen) {
		long __functionAddress = GL.getCapabilities().CGLSetVirtualScreen;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLGetVirtualScreen(long ctx, long screen) {
		long __functionAddress = GL.getCapabilities().CGLGetVirtualScreen;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int CGLUpdateContext(long ctx) {
		long __functionAddress = GL.getCapabilities().CGLUpdateContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int nCGLSetGlobalOption(int pname, long params) {
		long __functionAddress = GL.getCapabilities().CGLSetGlobalOption;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int nCGLGetGlobalOption(int pname, long params) {
		long __functionAddress = GL.getCapabilities().CGLGetGlobalOption;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
		return callIPI(__functionAddress, pname, params);
	}
	...
	public static int CGLLockContext(long context) {
		long __functionAddress = GL.getCapabilities().CGLLockContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(context);
		}
	...
	public static int CGLUnlockContext(long context) {
		long __functionAddress = GL.getCapabilities().CGLUnlockContext;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(context);
		}
	...
	public static void nCGLGetVersion(long majorvers, long minorvers) {
		long __functionAddress = GL.getCapabilities().CGLGetVersion;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static long nCGLErrorString(int error) {
		long __functionAddress = GL.getCapabilities().CGLErrorString;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);

...
shadow2DRectProjGradARB(
	...
	GLCapabilities(FunctionProvider provider, Set<String> ext, boolean fc) {
		...
		CGLChoosePixelFormat = getFunctionAddress(MACOSX, provider, "CGLChoosePixelFormat");
		CGLClearDrawable = getFunctionAddress(MACOSX, provider, "CGLClearDrawable");
		CGLCopyContext = getFunctionAddress(MACOSX, provider, "CGLCopyContext");
		CGLCreateContext = getFunctionAddress(MACOSX, provider, "CGLCreateContext");
		CGLCreatePBuffer = getFunctionAddress(MACOSX, provider, "CGLCreatePBuffer");
		CGLDescribePBuffer = getFunctionAddress(MACOSX, provider, "CGLDescribePBuffer");
		CGLDescribePixelFormat = getFunctionAddress(MACOSX, provider, "CGLDescribePixelFormat");
		CGLDescribeRenderer = getFunctionAddress(MACOSX, provider, "CGLDescribeRenderer");
		CGLDestroyContext = getFunctionAddress(MACOSX, provider, "CGLDestroyContext");
		CGLDestroyPBuffer = getFunctionAddress(MACOSX, provider, "CGLDestroyPBuffer");
		CGLDestroyPixelFormat = getFunctionAddress(MACOSX, provider, "CGLDestroyPixelFormat");
		CGLDestroyRendererInfo = getFunctionAddress(MACOSX, provider, "CGLDestroyRendererInfo");
		CGLDisable = getFunctionAddress(MACOSX, provider, "CGLDisable");
		CGLEnable = getFunctionAddress(MACOSX, provider, "CGLEnable");
		CGLErrorString = getFunctionAddress(MACOSX, provider, "CGLErrorString");
		CGLFlushDrawable = getFunctionAddress(MACOSX, provider, "CGLFlushDrawable");
		CGLGetContextRetainCount = getFunctionAddress(MACOSX, provider, "CGLGetContextRetainCount");
		CGLGetCurrentContext = getFunctionAddress(MACOSX, provider, "CGLGetCurrentContext");
		CGLGetGlobalOption = getFunctionAddress(MACOSX, provider, "CGLGetGlobalOption");
		CGLGetOffScreen = getFunctionAddress(MACOSX, provider, "CGLGetOffScreen");
		CGLGetPBuffer = getFunctionAddress(MACOSX, provider, "CGLGetPBuffer");
		CGLGetPBufferRetainCount = getFunctionAddress(MACOSX, provider, "CGLGetPBufferRetainCount");
		CGLGetParameter = getFunctionAddress(MACOSX, provider, "CGLGetParameter");
		CGLGetPixelFormat = getFunctionAddress(MACOSX, provider, "CGLGetPixelFormat");
		CGLGetPixelFormatRetainCount = getFunctionAddress(MACOSX, provider, "CGLGetPixelFormatRetainCount");
		CGLGetShareGroup = getFunctionAddress(MACOSX, provider, "CGLGetShareGroup");
		CGLGetVersion = getFunctionAddress(MACOSX, provider, "CGLGetVersion");
		CGLGetVirtualScreen = getFunctionAddress(MACOSX, provider, "CGLGetVirtualScreen");
		CGLIsEnabled = getFunctionAddress(MACOSX, provider, "CGLIsEnabled");
		CGLLockContext = getFunctionAddress(MACOSX, provider, "CGLLockContext");
		CGLQueryRendererInfo = getFunctionAddress(MACOSX, provider, "CGLQueryRendererInfo");
		CGLReleaseContext = getFunctionAddress(MACOSX, provider, "CGLReleaseContext");
		CGLReleasePBuffer = getFunctionAddress(MACOSX, provider, "CGLReleasePBuffer");
		CGLReleasePixelFormat = getFunctionAddress(MACOSX, provider, "CGLReleasePixelFormat");
		CGLRetainContext = getFunctionAddress(MACOSX, provider, "CGLRetainContext");
		CGLRetainPBuffer = getFunctionAddress(MACOSX, provider, "CGLRetainPBuffer");
		CGLRetainPixelFormat = getFunctionAddress(MACOSX, provider, "CGLRetainPixelFormat");
		CGLSetCurrentContext = getFunctionAddress(MACOSX, provider, "CGLSetCurrentContext");
		CGLSetFullScreen = getFunctionAddress(MACOSX, provider, "CGLSetFullScreen");
		CGLSetFullScreenOnDisplay = getFunctionAddress(MACOSX, provider, "CGLSetFullScreenOnDisplay");
		CGLSetGlobalOption = getFunctionAddress(MACOSX, provider, "CGLSetGlobalOption");
		CGLSetOffScreen = getFunctionAddress(MACOSX, provider, "CGLSetOffScreen");
		CGLSetPBuffer = getFunctionAddress(MACOSX, provider, "CGLSetPBuffer");
		CGLSetParameter = getFunctionAddress(MACOSX, provider, "CGLSetParameter");
		CGLSetVirtualScreen = getFunctionAddress(MACOSX, provider, "CGLSetVirtualScreen");
		CGLTexImagePBuffer = getFunctionAddress(MACOSX, provider, "CGLTexImagePBuffer");
		CGLUnlockContext = getFunctionAddress(MACOSX, provider, "CGLUnlockContext");
		CGLUpdateContext = getFunctionAddress(MACOSX, provider, "CGLUpdateContext");
		...
		glClearIndex = GL.getFunctionAddress(provider, "glClearIndex", fc);
		...
		glColorP3ui = GL.getFunctionAddress(provider, "glColorP3ui", fc);
		glColorP3uiv = GL.getFunctionAddress(provider, "glColorP3uiv", fc);
		glColorP4ui = GL.getFunctionAddress(provider, "glColorP4ui", fc);
		glColorP4uiv = GL.getFunctionAddress(provider, "glColorP4uiv", fc);
		...
		glIndexMask = GL.getFunctionAddress(provider, "glIndexMask", fc);
		glIndexPointer = GL.getFunctionAddress(provider, "glIndexPointer", fc);
		glIndexd = GL.getFunctionAddress(provider, "glIndexd", fc);
		glIndexdv = GL.getFunctionAddress(provider, "glIndexdv", fc);
		glIndexf = GL.getFunctionAddress(provider, "glIndexf", fc);
		glIndexfv = GL.getFunctionAddress(provider, "glIndexfv", fc);
		glIndexi = GL.getFunctionAddress(provider, "glIndexi", fc);
		glIndexiv = GL.getFunctionAddress(provider, "glIndexiv", fc);
		glIndexs = GL.getFunctionAddress(provider, "glIndexs", fc);
		glIndexsv = GL.getFunctionAddress(provider, "glIndexsv", fc);
		glIndexub = GL.getFunctionAddress(provider, "glIndexub", fc);
		glIndexubv = GL.getFunctionAddress(provider, "glIndexubv", fc);
		...
		glMultiTexCoordP1uiv = GL.getFunctionAddress(provider, "glMultiTexCoordP1uiv", fc);
		glMultiTexCoordP2ui = GL.getFunctionAddress(provider, "glMultiTexCoordP2ui", fc);
		glMultiTexCoordP2uiv = GL.getFunctionAddress(provider, "glMultiTexCoordP2uiv", fc);
		glMultiTexCoordP3ui = GL.getFunctionAddress(provider, "glMultiTexCoordP3ui", fc);
		glMultiTexCoordP3uiv = GL.getFunctionAddress(provider, "glMultiTexCoordP3uiv", fc);
		glMultiTexCoordP4ui = GL.getFunctionAddress(provider, "glMultiTexCoordP4ui", fc);
		glMultiTexCoordP4uiv = GL.getFunctionAddress(provider, "glMultiTexCoordP4uiv", fc);
		...
		glNormalP3ui = GL.getFunctionAddress(provider, "glNormalP3ui", fc);
		glNormalP3uiv = GL.getFunctionAddress(provider, "glNormalP3uiv", fc);
		...
		glSecondaryColorP3ui = GL.getFunctionAddress(provider, "glSecondaryColorP3ui", fc);
		glSecondaryColorP3uiv = GL.getFunctionAddress(provider, "glSecondaryColorP3uiv", fc);
		...
		glTexCoordP1uiv = GL.getFunctionAddress(provider, "glTexCoordP1uiv", fc);
		glTexCoordP2ui = GL.getFunctionAddress(provider, "glTexCoordP2ui", fc);
		glTexCoordP2uiv = GL.getFunctionAddress(provider, "glTexCoordP2uiv", fc);
		glTexCoordP3ui = GL.getFunctionAddress(provider, "glTexCoordP3ui", fc);
		glTexCoordP3uiv = GL.getFunctionAddress(provider, "glTexCoordP3uiv", fc);
		glTexCoordP4ui = GL.getFunctionAddress(provider, "glTexCoordP4ui", fc);
		glTexCoordP4uiv = GL.getFunctionAddress(provider, "glTexCoordP4uiv", fc);
		...
		glVertexP2uiv = GL.getFunctionAddress(provider, "glVertexP2uiv", fc);
		glVertexP3ui = GL.getFunctionAddress(provider, "glVertexP3ui", fc);
		glVertexP3uiv = GL.getFunctionAddress(provider, "glVertexP3uiv", fc);
		glVertexP4ui = GL.getFunctionAddress(provider, "glVertexP4ui", fc);
		glVertexP4uiv = GL.getFunctionAddress(provider, "glVertexP4uiv", fc);
		...
		glXBindSwapBarrierNV = getFunctionAddress(LINUX, provider, "glXBindSwapBarrierNV");
		glXBindSwapBarrierSGIX = getFunctionAddress(LINUX, provider, "glXBindSwapBarrierSGIX");
		glXBindTexImageEXT = getFunctionAddress(LINUX, provider, "glXBindTexImageEXT");
		glXBlitContextFramebufferAMD = getFunctionAddress(LINUX, provider, "glXBlitContextFramebufferAMD");
		glXChooseFBConfig = getFunctionAddress(LINUX, provider, "glXChooseFBConfig");
		glXChooseFBConfigSGIX = getFunctionAddress(LINUX, provider, "glXChooseFBConfigSGIX");
		glXChooseVisual = getFunctionAddress(LINUX, provider, "glXChooseVisual");
		glXCopyBufferSubDataNV = getFunctionAddress(LINUX, provider, "glXCopyBufferSubDataNV");
		glXCopyContext = getFunctionAddress(LINUX, provider, "glXCopyContext");
		glXCopyImageSubDataNV = getFunctionAddress(LINUX, provider, "glXCopyImageSubDataNV");
		glXCreateAssociatedContextAMD = getFunctionAddress(LINUX, provider, "glXCreateAssociatedContextAMD");
		glXCreateAssociatedContextAttribsAMD = getFunctionAddress(LINUX, provider, "glXCreateAssociatedContextAttribsAMD");
		glXCreateContext = getFunctionAddress(LINUX, provider, "glXCreateContext");
		glXCreateContextAttribsARB = getFunctionAddress(LINUX, provider, "glXCreateContextAttribsARB");
		glXCreateContextWithConfigSGIX = getFunctionAddress(LINUX, provider, "glXCreateContextWithConfigSGIX");
		glXCreateGLXPbufferSGIX = getFunctionAddress(LINUX, provider, "glXCreateGLXPbufferSGIX");
		glXCreateGLXPixmap = getFunctionAddress(LINUX, provider, "glXCreateGLXPixmap");
		glXCreateGLXPixmapWithConfigSGIX = getFunctionAddress(LINUX, provider, "glXCreateGLXPixmapWithConfigSGIX");
		glXCreateNewContext = getFunctionAddress(LINUX, provider, "glXCreateNewContext");
		glXCreatePbuffer = getFunctionAddress(LINUX, provider, "glXCreatePbuffer");
		glXCreatePixmap = getFunctionAddress(LINUX, provider, "glXCreatePixmap");
		glXCreateWindow = getFunctionAddress(LINUX, provider, "glXCreateWindow");
		glXDelayBeforeSwapNV = getFunctionAddress(LINUX, provider, "glXDelayBeforeSwapNV");
		glXDeleteAssociatedContextAMD = getFunctionAddress(LINUX, provider, "glXDeleteAssociatedContextAMD");
		glXDestroyContext = getFunctionAddress(LINUX, provider, "glXDestroyContext");
		glXDestroyGLXPbufferSGIX = getFunctionAddress(LINUX, provider, "glXDestroyGLXPbufferSGIX");
		glXDestroyGLXPixmap = getFunctionAddress(LINUX, provider, "glXDestroyGLXPixmap");
		glXDestroyPbuffer = getFunctionAddress(LINUX, provider, "glXDestroyPbuffer");
		glXDestroyPixmap = getFunctionAddress(LINUX, provider, "glXDestroyPixmap");
		glXFreeContextEXT = getFunctionAddress(LINUX, provider, "glXFreeContextEXT");
		glXGetClientString = getFunctionAddress(LINUX, provider, "glXGetClientString");
		glXGetConfig = getFunctionAddress(LINUX, provider, "glXGetConfig");
		glXGetContextGPUIDAMD = getFunctionAddress(LINUX, provider, "glXGetContextGPUIDAMD");
		glXGetContextIDEXT = getFunctionAddress(LINUX, provider, "glXGetContextIDEXT");
		glXGetCurrentAssociatedContextAMD = getFunctionAddress(LINUX, provider, "glXGetCurrentAssociatedContextAMD");
		glXGetCurrentContext = getFunctionAddress(LINUX, provider, "glXGetCurrentContext");
		glXGetCurrentDisplay = getFunctionAddress(LINUX, provider, "glXGetCurrentDisplay");
		glXGetCurrentDisplayEXT = getFunctionAddress(LINUX, provider, "glXGetCurrentDisplayEXT");
		glXGetCurrentDrawable = getFunctionAddress(LINUX, provider, "glXGetCurrentDrawable");
		glXGetCurrentReadDrawable = getFunctionAddress(LINUX, provider, "glXGetCurrentReadDrawable");
		glXGetCurrentReadDrawableSGI = getFunctionAddress(LINUX, provider, "glXGetCurrentReadDrawableSGI");
		glXGetFBConfigAttrib = getFunctionAddress(LINUX, provider, "glXGetFBConfigAttrib");
		glXGetFBConfigAttribSGIX = getFunctionAddress(LINUX, provider, "glXGetFBConfigAttribSGIX");
		glXGetFBConfigFromVisualSGIX = getFunctionAddress(LINUX, provider, "glXGetFBConfigFromVisualSGIX");
		glXGetFBConfigs = getFunctionAddress(LINUX, provider, "glXGetFBConfigs");
		glXGetGPUIDsAMD = getFunctionAddress(LINUX, provider, "glXGetGPUIDsAMD");
		glXGetGPUInfoAMD = getFunctionAddress(LINUX, provider, "glXGetGPUInfoAMD");
		glXGetProcAddress = getFunctionAddress(LINUX, provider, "glXGetProcAddress");
		glXGetProcAddressARB = getFunctionAddress(LINUX, provider, "glXGetProcAddressARB");
		glXGetSelectedEvent = getFunctionAddress(LINUX, provider, "glXGetSelectedEvent");
		glXGetSelectedEventSGIX = getFunctionAddress(LINUX, provider, "glXGetSelectedEventSGIX");
		glXGetVideoSyncSGI = getFunctionAddress(LINUX, provider, "glXGetVideoSyncSGI");
		glXGetVisualFromFBConfig = getFunctionAddress(LINUX, provider, "glXGetVisualFromFBConfig");
		glXGetVisualFromFBConfigSGIX = getFunctionAddress(LINUX, provider, "glXGetVisualFromFBConfigSGIX");
		glXImportContextEXT = getFunctionAddress(LINUX, provider, "glXImportContextEXT");
		glXIsDirect = getFunctionAddress(LINUX, provider, "glXIsDirect");
		glXJoinSwapGroupNV = getFunctionAddress(LINUX, provider, "glXJoinSwapGroupNV");
		glXJoinSwapGroupSGIX = getFunctionAddress(LINUX, provider, "glXJoinSwapGroupSGIX");
		glXMakeAssociatedContextCurrentAMD = getFunctionAddress(LINUX, provider, "glXMakeAssociatedContextCurrentAMD");
		glXMakeContextCurrent = getFunctionAddress(LINUX, provider, "glXMakeContextCurrent");
		glXMakeCurrent = getFunctionAddress(LINUX, provider, "glXMakeCurrent");
		glXMakeCurrentReadSGI = getFunctionAddress(LINUX, provider, "glXMakeCurrentReadSGI");
		glXNamedCopyBufferSubDataNV = getFunctionAddress(LINUX, provider, "glXNamedCopyBufferSubDataNV");
		glXQueryContext = getFunctionAddress(LINUX, provider, "glXQueryContext");
		glXQueryContextInfoEXT = getFunctionAddress(LINUX, provider, "glXQueryContextInfoEXT");
		glXQueryDrawable = getFunctionAddress(LINUX, provider, "glXQueryDrawable");
		glXQueryExtension = getFunctionAddress(LINUX, provider, "glXQueryExtension");
		glXQueryExtensionsString = getFunctionAddress(LINUX, provider, "glXQueryExtensionsString");
		glXQueryFrameCountNV = getFunctionAddress(LINUX, provider, "glXQueryFrameCountNV");
		glXQueryGLXPbufferSGIX = getFunctionAddress(LINUX, provider, "glXQueryGLXPbufferSGIX");
		glXQueryMaxSwapBarriersSGIX = getFunctionAddress(LINUX, provider, "glXQueryMaxSwapBarriersSGIX");
		glXQueryMaxSwapGroupsNV = getFunctionAddress(LINUX, provider, "glXQueryMaxSwapGroupsNV");
		glXQueryServerString = getFunctionAddress(LINUX, provider, "glXQueryServerString");
		glXQuerySwapGroupNV = getFunctionAddress(LINUX, provider, "glXQuerySwapGroupNV");
		glXQueryVersion = getFunctionAddress(LINUX, provider, "glXQueryVersion");
		glXReleaseTexImageEXT = getFunctionAddress(LINUX, provider, "glXReleaseTexImageEXT");
		glXResetFrameCountNV = getFunctionAddress(LINUX, provider, "glXResetFrameCountNV");
		glXSelectEvent = getFunctionAddress(LINUX, provider, "glXSelectEvent");
		glXSelectEventSGIX = getFunctionAddress(LINUX, provider, "glXSelectEventSGIX");
		glXSwapBuffers = getFunctionAddress(LINUX, provider, "glXSwapBuffers");
		glXSwapIntervalEXT = getFunctionAddress(LINUX, provider, "glXSwapIntervalEXT");
		glXSwapIntervalSGI = getFunctionAddress(LINUX, provider, "glXSwapIntervalSGI");
		glXUseXFont = getFunctionAddress(LINUX, provider, "glXUseXFont");
		glXWaitGL = getFunctionAddress(LINUX, provider, "glXWaitGL");
		glXWaitVideoSyncSGI = getFunctionAddress(LINUX, provider, "glXWaitVideoSyncSGI");
		glXWaitX = getFunctionAddress(LINUX, provider, "glXWaitX");

		wglAllocateMemoryNV = getFunctionAddress(WINDOWS, provider, "wglAllocateMemoryNV");
		wglBindSwapBarrierNV = getFunctionAddress(WINDOWS, provider, "wglBindSwapBarrierNV");
		wglBindTexImageARB = getFunctionAddress(WINDOWS, provider, "wglBindTexImageARB");
		wglBlitContextFramebufferAMD = getFunctionAddress(WINDOWS, provider, "wglBlitContextFramebufferAMD");
		wglChoosePixelFormatARB = getFunctionAddress(WINDOWS, provider, "wglChoosePixelFormatARB");
		wglCopyContext = getFunctionAddress(WINDOWS, provider, "wglCopyContext");
		wglCopyImageSubDataNV = getFunctionAddress(WINDOWS, provider, "wglCopyImageSubDataNV");
		wglCreateAffinityDCNV = getFunctionAddress(WINDOWS, provider, "wglCreateAffinityDCNV");
		wglCreateAssociatedContextAMD = getFunctionAddress(WINDOWS, provider, "wglCreateAssociatedContextAMD");
		wglCreateAssociatedContextAttribsAMD = getFunctionAddress(WINDOWS, provider, "wglCreateAssociatedContextAttribsAMD");
		wglCreateBufferRegionARB = getFunctionAddress(WINDOWS, provider, "wglCreateBufferRegionARB");
		wglCreateContext = getFunctionAddress(WINDOWS, provider, "wglCreateContext");
		wglCreateContextAttribsARB = getFunctionAddress(WINDOWS, provider, "wglCreateContextAttribsARB");
		wglCreateLayerContext = getFunctionAddress(WINDOWS, provider, "wglCreateLayerContext");
		wglCreatePbufferARB = getFunctionAddress(WINDOWS, provider, "wglCreatePbufferARB");
		wglDXCloseDeviceNV = getFunctionAddress(WINDOWS, provider, "wglDXCloseDeviceNV");
		wglDXLockObjectsNV = getFunctionAddress(WINDOWS, provider, "wglDXLockObjectsNV");
		wglDXObjectAccessNV = getFunctionAddress(WINDOWS, provider, "wglDXObjectAccessNV");
		wglDXOpenDeviceNV = getFunctionAddress(WINDOWS, provider, "wglDXOpenDeviceNV");
		wglDXRegisterObjectNV = getFunctionAddress(WINDOWS, provider, "wglDXRegisterObjectNV");
		wglDXSetResourceShareHandleNV = getFunctionAddress(WINDOWS, provider, "wglDXSetResourceShareHandleNV");
		wglDXUnlockObjectsNV = getFunctionAddress(WINDOWS, provider, "wglDXUnlockObjectsNV");
		wglDXUnregisterObjectNV = getFunctionAddress(WINDOWS, provider, "wglDXUnregisterObjectNV");
		wglDelayBeforeSwapNV = getFunctionAddress(WINDOWS, provider, "wglDelayBeforeSwapNV");
		wglDeleteAssociatedContextAMD = getFunctionAddress(WINDOWS, provider, "wglDeleteAssociatedContextAMD");
		wglDeleteBufferRegionARB = getFunctionAddress(WINDOWS, provider, "wglDeleteBufferRegionARB");
		wglDeleteContext = getFunctionAddress(WINDOWS, provider, "wglDeleteContext");
		wglDeleteDCNV = getFunctionAddress(WINDOWS, provider, "wglDeleteDCNV");
		wglDestroyPbufferARB = getFunctionAddress(WINDOWS, provider, "wglDestroyPbufferARB");
		wglEnumGpuDevicesNV = getFunctionAddress(WINDOWS, provider, "wglEnumGpuDevicesNV");
		wglEnumGpusFromAffinityDCNV = getFunctionAddress(WINDOWS, provider, "wglEnumGpusFromAffinityDCNV");
		wglEnumGpusNV = getFunctionAddress(WINDOWS, provider, "wglEnumGpusNV");
		wglFreeMemoryNV = getFunctionAddress(WINDOWS, provider, "wglFreeMemoryNV");
		wglGetContextGPUIDAMD = getFunctionAddress(WINDOWS, provider, "wglGetContextGPUIDAMD");
		wglGetCurrentAssociatedContextAMD = getFunctionAddress(WINDOWS, provider, "wglGetCurrentAssociatedContextAMD");
		wglGetCurrentContext = getFunctionAddress(WINDOWS, provider, "wglGetCurrentContext");
		wglGetCurrentDC = getFunctionAddress(WINDOWS, provider, "wglGetCurrentDC");
		wglGetCurrentReadDCARB = getFunctionAddress(WINDOWS, provider, "wglGetCurrentReadDCARB");
		wglGetExtensionsStringARB = getFunctionAddress(WINDOWS, provider, "wglGetExtensionsStringARB");
		wglGetExtensionsStringEXT = getFunctionAddress(WINDOWS, provider, "wglGetExtensionsStringEXT");
		wglGetGPUIDsAMD = getFunctionAddress(WINDOWS, provider, "wglGetGPUIDsAMD");
		wglGetGPUInfoAMD = getFunctionAddress(WINDOWS, provider, "wglGetGPUInfoAMD");
		wglGetPbufferDCARB = getFunctionAddress(WINDOWS, provider, "wglGetPbufferDCARB");
		wglGetPixelFormatAttribfvARB = getFunctionAddress(WINDOWS, provider, "wglGetPixelFormatAttribfvARB");
		wglGetPixelFormatAttribivARB = getFunctionAddress(WINDOWS, provider, "wglGetPixelFormatAttribivARB");
		wglGetProcAddress = getFunctionAddress(WINDOWS, provider, "wglGetProcAddress");
		wglGetSwapIntervalEXT = getFunctionAddress(WINDOWS, provider, "wglGetSwapIntervalEXT");
		wglJoinSwapGroupNV = getFunctionAddress(WINDOWS, provider, "wglJoinSwapGroupNV");
		wglMakeAssociatedContextCurrentAMD = getFunctionAddress(WINDOWS, provider, "wglMakeAssociatedContextCurrentAMD");
		wglMakeContextCurrentARB = getFunctionAddress(WINDOWS, provider, "wglMakeContextCurrentARB");
		wglMakeCurrent = getFunctionAddress(WINDOWS, provider, "wglMakeCurrent");
		wglQueryFrameCountNV = getFunctionAddress(WINDOWS, provider, "wglQueryFrameCountNV");
		wglQueryMaxSwapGroupsNV = getFunctionAddress(WINDOWS, provider, "wglQueryMaxSwapGroupsNV");
		wglQueryPbufferARB = getFunctionAddress(WINDOWS, provider, "wglQueryPbufferARB");
		wglQuerySwapGroupNV = getFunctionAddress(WINDOWS, provider, "wglQuerySwapGroupNV");
		wglReleasePbufferDCARB = getFunctionAddress(WINDOWS, provider, "wglReleasePbufferDCARB");
		wglReleaseTexImageARB = getFunctionAddress(WINDOWS, provider, "wglReleaseTexImageARB");
		wglResetFrameCountNV = getFunctionAddress(WINDOWS, provider, "wglResetFrameCountNV");
		wglRestoreBufferRegionARB = getFunctionAddress(WINDOWS, provider, "wglRestoreBufferRegionARB");
		wglSaveBufferRegionARB = getFunctionAddress(WINDOWS, provider, "wglSaveBufferRegionARB");
		wglSetPbufferAttribARB = getFunctionAddress(WINDOWS, provider, "wglSetPbufferAttribARB");
		wglShareLists = getFunctionAddress(WINDOWS, provider, "wglShareLists");
		wglSwapIntervalEXT = getFunctionAddress(WINDOWS, provider, "wglSwapIntervalEXT");
		wglUseFontBitmaps = getFunctionAddress(WINDOWS, provider, "wglUseFontBitmapsW");
		wglUseFontOutlines = getFunctionAddress(WINDOWS, provider, "wglUseFontOutlinesW");

		OpenGL11 = ext.contains("OpenGL11") && GL.checkExtension("OpenGL11", GL11.isAvailable(this, fc));
		OpenGL12 = ext.contains("OpenGL12") && GL.checkExtension("OpenGL12", GL12.isAvailable(this));
		OpenGL13 = ext.contains("OpenGL13") && GL.checkExtension("OpenGL13", GL13.isAvailable(this, fc));
		OpenGL14 = ext.contains("OpenGL14") && GL.checkExtension("OpenGL14", GL14.isAvailable(this, fc));
		OpenGL15 = ext.contains("OpenGL15") && GL.checkExtension("OpenGL15", GL15.isAvailable(this));
		OpenGL20 = ext.contains("OpenGL20") && GL.checkExtension("OpenGL20", GL20.isAvailable(this));
		OpenGL21 = ext.contains("OpenGL21") && GL.checkExtension("OpenGL21", GL21.isAvailable(this));
		OpenGL30 = ext.contains("OpenGL30") && GL.checkExtension("OpenGL30", GL30.isAvailable(this));
		OpenGL31 = ext.contains("OpenGL31") && GL.checkExtension("OpenGL31", GL31.isAvailable(this));
		OpenGL32 = ext.contains("OpenGL32") && GL.checkExtension("OpenGL32", GL32.isAvailable(this));
		OpenGL33 = ext.contains("OpenGL33") && GL.checkExtension("OpenGL33", GL33.isAvailable(this, fc));
		OpenGL40 = ext.contains("OpenGL40") && GL.checkExtension("OpenGL40", GL40.isAvailable(this));
		OpenGL41 = ext.contains("OpenGL41") && GL.checkExtension("OpenGL41", GL41.isAvailable(this));
		OpenGL42 = ext.contains("OpenGL42") && GL.checkExtension("OpenGL42", GL42.isAvailable(this));
		OpenGL43 = ext.contains("OpenGL43") && GL.checkExtension("OpenGL43", GL43.isAvailable(this));
		OpenGL44 = ext.contains("OpenGL44") && GL.checkExtension("OpenGL44", GL44.isAvailable(this));
		OpenGL45 = ext.contains("OpenGL45") && GL.checkExtension("OpenGL45", GL45.isAvailable(this, ext));
		GLX = ext.contains("GLX") && GL.checkExtension("GLX", org.lwjgl.opengl.GLX.isAvailable(this));
		GLX11 = ext.contains("GLX11") && GL.checkExtension("GLX11", org.lwjgl.opengl.GLX11.isAvailable(this));
		GLX12 = ext.contains("GLX12") && GL.checkExtension("GLX12", org.lwjgl.opengl.GLX12.isAvailable(this));
		GLX13 = ext.contains("GLX13") && GL.checkExtension("GLX13", org.lwjgl.opengl.GLX13.isAvailable(this));
		GLX14 = ext.contains("GLX14") && GL.checkExtension("GLX14", org.lwjgl.opengl.GLX14.isAvailable(this));
		GLX_AMD_gpu_association = ext.contains("GLX_AMD_gpu_association") && GL.checkExtension("GLX_AMD_gpu_association", GLXAMDGPUAssociation.isAvailable(this));
		GLX_ARB_context_flush_control = ext.contains("GLX_ARB_context_flush_control");
		GLX_ARB_create_context = ext.contains("GLX_ARB_create_context") && GL.checkExtension("GLX_ARB_create_context", GLXARBCreateContext.isAvailable(this));
		...
		GLX_ARB_get_proc_address = ext.contains("GLX_ARB_get_proc_address") && GL.checkExtension("GLX_ARB_get_proc_address", GLXARBGetProcAddress.isAvailable(this));
		...
		GLX_EXT_import_context = ext.contains("GLX_EXT_import_context") && GL.checkExtension("GLX_EXT_import_context", GLXEXTImportContext.isAvailable(this));
		GLX_EXT_stereo_tree = ext.contains("GLX_EXT_stereo_tree");
		GLX_EXT_swap_control = ext.contains("GLX_EXT_swap_control") && GL.checkExtension("GLX_EXT_swap_control", GLXEXTSwapControl.isAvailable(this));
		GLX_EXT_swap_control_tear = ext.contains("GLX_EXT_swap_control_tear");
		GLX_EXT_texture_from_pixmap = ext.contains("GLX_EXT_texture_from_pixmap") && GL.checkExtension("GLX_EXT_texture_from_pixmap", GLXEXTTextureFromPixmap.isAvailable(this));
		...
		GLX_NV_copy_buffer = ext.contains("GLX_NV_copy_buffer") && GL.checkExtension("GLX_NV_copy_buffer", GLXNVCopyBuffer.isAvailable(this));
		GLX_NV_copy_image = ext.contains("GLX_NV_copy_image") && GL.checkExtension("GLX_NV_copy_image", GLXNVCopyImage.isAvailable(this));
		GLX_NV_delay_before_swap = ext.contains("GLX_NV_delay_before_swap") && GL.checkExtension("GLX_NV_delay_before_swap", GLXNVDelayBeforeSwap.isAvailable(this));
		GLX_NV_float_buffer = ext.contains("GLX_NV_float_buffer");
		GLX_NV_multisample_coverage = ext.contains("GLX_NV_multisample_coverage");
		GLX_NV_swap_group = ext.contains("GLX_NV_swap_group") && GL.checkExtension("GLX_NV_swap_group", GLXNVSwapGroup.isAvailable(this));
		GLX_SGI_make_current_read = ext.contains("GLX_SGI_make_current_read") && GL.checkExtension("GLX_SGI_make_current_read", GLXSGIMakeCurrentRead.isAvailable(this));
		GLX_SGI_swap_control = ext.contains("GLX_SGI_swap_control") && GL.checkExtension("GLX_SGI_swap_control", GLXSGISwapControl.isAvailable(this));
		GLX_SGI_video_sync = ext.contains("GLX_SGI_video_sync") && GL.checkExtension("GLX_SGI_video_sync", GLXSGIVideoSync.isAvailable(this));
		GLX_SGIX_fbconfig = ext.contains("GLX_SGIX_fbconfig") && GL.checkExtension("GLX_SGIX_fbconfig", GLXSGIXFBConfig.isAvailable(this));
		GLX_SGIX_pbuffer = ext.contains("GLX_SGIX_pbuffer") && GL.checkExtension("GLX_SGIX_pbuffer", GLXSGIXPbuffer.isAvailable(this));
		GLX_SGIX_swap_barrier = ext.contains("GLX_SGIX_swap_barrier") && GL.checkExtension("GLX_SGIX_swap_barrier", GLXSGIXSwapBarrier.isAvailable(this));
		GLX_SGIX_swap_group = ext.contains("GLX_SGIX_swap_group") && GL.checkExtension("GLX_SGIX_swap_group", GLXSGIXSwapGroup.isAvailable(this));
		...
		GL_AMD_debug_output = ext.contains("GL_AMD_debug_output") && GL.checkExtension("GL_AMD_debug_output", AMDDebugOutput.isAvailable(this));
		GL_AMD_depth_clamp_separate = ext.contains("GL_AMD_depth_clamp_separate");
		GL_AMD_draw_buffers_blend = ext.contains("GL_AMD_draw_buffers_blend") && GL.checkExtension("GL_AMD_draw_buffers_blend", AMDDrawBuffersBlend.isAvailable(this));
		GL_AMD_gcn_shader = ext.contains("GL_AMD_gcn_shader");
		GL_AMD_gpu_shader_int64 = ext.contains("GL_AMD_gpu_shader_int64") && GL.checkExtension("GL_AMD_gpu_shader_int64", AMDGPUShaderInt64.isAvailable(this));
		GL_AMD_interleaved_elements = ext.contains("GL_AMD_interleaved_elements") && GL.checkExtension("GL_AMD_interleaved_elements", AMDInterleavedElements.isAvailable(this));
		GL_AMD_occlusion_query_event = ext.contains("GL_AMD_occlusion_query_event") && GL.checkExtension("GL_AMD_occlusion_query_event", AMDOcclusionQueryEvent.isAvailable(this));
		GL_AMD_performance_monitor = ext.contains("GL_AMD_performance_monitor") && GL.checkExtension("GL_AMD_performance_monitor", AMDPerformanceMonitor.isAvailable(this));
		GL_AMD_pinned_memory = ext.contains("GL_AMD_pinned_memory");
		GL_AMD_query_buffer_object = ext.contains("GL_AMD_query_buffer_object");
		GL_AMD_sample_positions = ext.contains("GL_AMD_sample_positions") && GL.checkExtension("GL_AMD_sample_positions", AMDSamplePositions.isAvailable(this));
		...
		GL_AMD_sparse_texture = ext.contains("GL_AMD_sparse_texture") && GL.checkExtension("GL_AMD_sparse_texture", AMDSparseTexture.isAvailable(this));
		GL_AMD_stencil_operation_extended = ext.contains("GL_AMD_stencil_operation_extended") && GL.checkExtension("GL_AMD_stencil_operation_extended", AMDStencilOperationExtended.isAvailable(this));
		...
		GL_AMD_vertex_shader_tessellator = ext.contains("GL_AMD_vertex_shader_tessellator") && GL.checkExtension("GL_AMD_vertex_shader_tessellator", AMDVertexShaderTessellator.isAvailable(this));
		...
		GL_ARB_base_instance = ext.contains("GL_ARB_base_instance") && GL.checkExtension("GL_ARB_base_instance", ARBBaseInstance.isAvailable(this));
		GL_ARB_bindless_texture = ext.contains("GL_ARB_bindless_texture") && GL.checkExtension("GL_ARB_bindless_texture", ARBBindlessTexture.isAvailable(this));
		GL_ARB_blend_func_extended = ext.contains("GL_ARB_blend_func_extended") && GL.checkExtension("GL_ARB_blend_func_extended", ARBBlendFuncExtended.isAvailable(this));
		GL_ARB_buffer_storage = ext.contains("GL_ARB_buffer_storage") && GL.checkExtension("GL_ARB_buffer_storage", ARBBufferStorage.isAvailable(this, ext));
		GL_ARB_cl_event = ext.contains("GL_ARB_cl_event") && GL.checkExtension("GL_ARB_cl_event", ARBCLEvent.isAvailable(this));
		GL_ARB_clear_buffer_object = ext.contains("GL_ARB_clear_buffer_object") && GL.checkExtension("GL_ARB_clear_buffer_object", ARBClearBufferObject.isAvailable(this, ext));
		GL_ARB_clear_texture = ext.contains("GL_ARB_clear_texture") && GL.checkExtension("GL_ARB_clear_texture", ARBClearTexture.isAvailable(this));
		GL_ARB_clip_control = ext.contains("GL_ARB_clip_control") && GL.checkExtension("GL_ARB_clip_control", ARBClipControl.isAvailable(this));
		GL_ARB_color_buffer_float = ext.contains("GL_ARB_color_buffer_float") && GL.checkExtension("GL_ARB_color_buffer_float", ARBColorBufferFloat.isAvailable(this));
		...
		GL_ARB_compute_shader = ext.contains("GL_ARB_compute_shader") && GL.checkExtension("GL_ARB_compute_shader", ARBComputeShader.isAvailable(this));
		GL_ARB_compute_variable_group_size = ext.contains("GL_ARB_compute_variable_group_size") && GL.checkExtension("GL_ARB_compute_variable_group_size", ARBComputeVariableGroupSize.isAvailable(this));
		...
		GL_ARB_copy_buffer = ext.contains("GL_ARB_copy_buffer") && GL.checkExtension("GL_ARB_copy_buffer", ARBCopyBuffer.isAvailable(this));
		GL_ARB_copy_image = ext.contains("GL_ARB_copy_image") && GL.checkExtension("GL_ARB_copy_image", ARBCopyImage.isAvailable(this));
		GL_ARB_cull_distance = ext.contains("GL_ARB_cull_distance");
		GL_ARB_debug_output = ext.contains("GL_ARB_debug_output") && GL.checkExtension("GL_ARB_debug_output", ARBDebugOutput.isAvailable(this));
		...
		GL_ARB_direct_state_access = ext.contains("GL_ARB_direct_state_access") && GL.checkExtension("GL_ARB_direct_state_access", ARBDirectStateAccess.isAvailable(this));
		GL_ARB_draw_buffers = ext.contains("GL_ARB_draw_buffers") && GL.checkExtension("GL_ARB_draw_buffers", ARBDrawBuffers.isAvailable(this));
		GL_ARB_draw_buffers_blend = ext.contains("GL_ARB_draw_buffers_blend") && GL.checkExtension("GL_ARB_draw_buffers_blend", ARBDrawBuffersBlend.isAvailable(this));
		GL_ARB_draw_elements_base_vertex = ext.contains("GL_ARB_draw_elements_base_vertex") && GL.checkExtension("GL_ARB_draw_elements_base_vertex", ARBDrawElementsBaseVertex.isAvailable(this));
		GL_ARB_draw_indirect = ext.contains("GL_ARB_draw_indirect") && GL.checkExtension("GL_ARB_draw_indirect", ARBDrawIndirect.isAvailable(this));
		GL_ARB_draw_instanced = ext.contains("GL_ARB_draw_instanced") && GL.checkExtension("GL_ARB_draw_instanced", ARBDrawInstanced.isAvailable(this));
		GL_ARB_enhanced_layouts = ext.contains("GL_ARB_enhanced_layouts");
		GL_ARB_ES2_compatibility = ext.contains("GL_ARB_ES2_compatibility") && GL.checkExtension("GL_ARB_ES2_compatibility", ARBES2Compatibility.isAvailable(this));
		GL_ARB_ES3_1_compatibility = ext.contains("GL_ARB_ES3_1_compatibility") && GL.checkExtension("GL_ARB_ES3_1_compatibility", ARBES31Compatibility.isAvailable(this));
		GL_ARB_ES3_2_compatibility = ext.contains("GL_ARB_ES3_2_compatibility") && GL.checkExtension("GL_ARB_ES3_2_compatibility", ARBES32Compatibility.isAvailable(this));
		...
		GL_ARB_framebuffer_no_attachments = ext.contains("GL_ARB_framebuffer_no_attachments") && GL.checkExtension("GL_ARB_framebuffer_no_attachments", ARBFramebufferNoAttachments.isAvailable(this, ext));
		GL_ARB_framebuffer_object = ext.contains("GL_ARB_framebuffer_object") && GL.checkExtension("GL_ARB_framebuffer_object", ARBFramebufferObject.isAvailable(this));
		GL_ARB_framebuffer_sRGB = ext.contains("GL_ARB_framebuffer_sRGB");
		GL_ARB_geometry_shader4 = ext.contains("GL_ARB_geometry_shader4") && GL.checkExtension("GL_ARB_geometry_shader4", ARBGeometryShader4.isAvailable(this));
		GL_ARB_get_program_binary = ext.contains("GL_ARB_get_program_binary") && GL.checkExtension("GL_ARB_get_program_binary", ARBGetProgramBinary.isAvailable(this));
		GL_ARB_get_texture_sub_image = ext.contains("GL_ARB_get_texture_sub_image") && GL.checkExtension("GL_ARB_get_texture_sub_image", ARBGetTextureSubImage.isAvailable(this));
		GL_ARB_gpu_shader5 = ext.contains("GL_ARB_gpu_shader5");
		GL_ARB_gpu_shader_fp64 = ext.contains("GL_ARB_gpu_shader_fp64") && GL.checkExtension("GL_ARB_gpu_shader_fp64", ARBGPUShaderFP64.isAvailable(this, ext));
		GL_ARB_gpu_shader_int64 = ext.contains("GL_ARB_gpu_shader_int64") && GL.checkExtension("GL_ARB_gpu_shader_int64", ARBGPUShaderInt64.isAvailable(this));
		...
		GL_ARB_imaging = ext.contains("GL_ARB_imaging") && GL.checkExtension("GL_ARB_imaging", ARBImaging.isAvailable(this, fc));
		GL_ARB_indirect_parameters = ext.contains("GL_ARB_indirect_parameters") && GL.checkExtension("GL_ARB_indirect_parameters", ARBIndirectParameters.isAvailable(this));
		GL_ARB_instanced_arrays = ext.contains("GL_ARB_instanced_arrays") && GL.checkExtension("GL_ARB_instanced_arrays", ARBInstancedArrays.isAvailable(this, ext));
		GL_ARB_internalformat_query = ext.contains("GL_ARB_internalformat_query") && GL.checkExtension("GL_ARB_internalformat_query", ARBInternalformatQuery.isAvailable(this));
		GL_ARB_internalformat_query2 = ext.contains("GL_ARB_internalformat_query2") && GL.checkExtension("GL_ARB_internalformat_query2", ARBInternalformatQuery2.isAvailable(this));
		GL_ARB_invalidate_subdata = ext.contains("GL_ARB_invalidate_subdata") && GL.checkExtension("GL_ARB_invalidate_subdata", ARBInvalidateSubdata.isAvailable(this));
		GL_ARB_map_buffer_alignment = ext.contains("GL_ARB_map_buffer_alignment");
		GL_ARB_map_buffer_range = ext.contains("GL_ARB_map_buffer_range") && GL.checkExtension("GL_ARB_map_buffer_range", ARBMapBufferRange.isAvailable(this));
		GL_ARB_matrix_palette = ext.contains("GL_ARB_matrix_palette") && GL.checkExtension("GL_ARB_matrix_palette", ARBMatrixPalette.isAvailable(this));
		GL_ARB_multi_bind = ext.contains("GL_ARB_multi_bind") && GL.checkExtension("GL_ARB_multi_bind", ARBMultiBind.isAvailable(this));
		GL_ARB_multi_draw_indirect = ext.contains("GL_ARB_multi_draw_indirect") && GL.checkExtension("GL_ARB_multi_draw_indirect", ARBMultiDrawIndirect.isAvailable(this));
		GL_ARB_multisample = ext.contains("GL_ARB_multisample") && GL.checkExtension("GL_ARB_multisample", ARBMultisample.isAvailable(this));
		GL_ARB_multitexture = ext.contains("GL_ARB_multitexture") && GL.checkExtension("GL_ARB_multitexture", ARBMultitexture.isAvailable(this));
		GL_ARB_occlusion_query = ext.contains("GL_ARB_occlusion_query") && GL.checkExtension("GL_ARB_occlusion_query", ARBOcclusionQuery.isAvailable(this));
		GL_ARB_occlusion_query2 = ext.contains("GL_ARB_occlusion_query2");
		GL_ARB_parallel_shader_compile = ext.contains("GL_ARB_parallel_shader_compile") && GL.checkExtension("GL_ARB_parallel_shader_compile", ARBParallelShaderCompile.isAvailable(this));
		...
		GL_ARB_point_parameters = ext.contains("GL_ARB_point_parameters") && GL.checkExtension("GL_ARB_point_parameters", ARBPointParameters.isAvailable(this));
		GL_ARB_point_sprite = ext.contains("GL_ARB_point_sprite");
		GL_ARB_post_depth_coverage = ext.contains("GL_ARB_post_depth_coverage");
		GL_ARB_program_interface_query = ext.contains("GL_ARB_program_interface_query") && GL.checkExtension("GL_ARB_program_interface_query", ARBProgramInterfaceQuery.isAvailable(this));
		GL_ARB_provoking_vertex = ext.contains("GL_ARB_provoking_vertex") && GL.checkExtension("GL_ARB_provoking_vertex", ARBProvokingVertex.isAvailable(this));
		...
		GL_ARB_robustness = ext.contains("GL_ARB_robustness") && GL.checkExtension("GL_ARB_robustness", ARBRobustness.isAvailable(this, ext));
		GL_ARB_robustness_isolation = ext.contains("GL_ARB_robustness_isolation");
		GL_ARB_sample_locations = ext.contains("GL_ARB_sample_locations") && GL.checkExtension("GL_ARB_sample_locations", ARBSampleLocations.isAvailable(this));
		GL_ARB_sample_shading = ext.contains("GL_ARB_sample_shading") && GL.checkExtension("GL_ARB_sample_shading", ARBSampleShading.isAvailable(this));
		GL_ARB_sampler_objects = ext.contains("GL_ARB_sampler_objects") && GL.checkExtension("GL_ARB_sampler_objects", ARBSamplerObjects.isAvailable(this));
		...
		GL_ARB_separate_shader_objects = ext.contains("GL_ARB_separate_shader_objects") && GL.checkExtension("GL_ARB_separate_shader_objects", ARBSeparateShaderObjects.isAvailable(this));
		GL_ARB_shader_atomic_counter_ops = ext.contains("GL_ARB_shader_atomic_counter_ops");
		GL_ARB_shader_atomic_counters = ext.contains("GL_ARB_shader_atomic_counters") && GL.checkExtension("GL_ARB_shader_atomic_counters", ARBShaderAtomicCounters.isAvailable(this));
		...
		GL_ARB_shader_image_load_store = ext.contains("GL_ARB_shader_image_load_store") && GL.checkExtension("GL_ARB_shader_image_load_store", ARBShaderImageLoadStore.isAvailable(this));
		GL_ARB_shader_image_size = ext.contains("GL_ARB_shader_image_size");
		GL_ARB_shader_objects = ext.contains("GL_ARB_shader_objects") && GL.checkExtension("GL_ARB_shader_objects", ARBShaderObjects.isAvailable(this));
		...
		GL_ARB_shader_storage_buffer_object = ext.contains("GL_ARB_shader_storage_buffer_object") && GL.checkExtension("GL_ARB_shader_storage_buffer_object", ARBShaderStorageBufferObject.isAvailable(this));
		GL_ARB_shader_subroutine = ext.contains("GL_ARB_shader_subroutine") && GL.checkExtension("GL_ARB_shader_subroutine", ARBShaderSubroutine.isAvailable(this));
		...
		GL_ARB_shading_language_include = ext.contains("GL_ARB_shading_language_include") && GL.checkExtension("GL_ARB_shading_language_include", ARBShadingLanguageInclude.isAvailable(this));
		...
		GL_ARB_sparse_buffer = ext.contains("GL_ARB_sparse_buffer") && GL.checkExtension("GL_ARB_sparse_buffer", ARBSparseBuffer.isAvailable(this, ext));
		GL_ARB_sparse_texture = ext.contains("GL_ARB_sparse_texture") && GL.checkExtension("GL_ARB_sparse_texture", ARBSparseTexture.isAvailable(this, ext));
		...
		GL_ARB_sync = ext.contains("GL_ARB_sync") && GL.checkExtension("GL_ARB_sync", ARBSync.isAvailable(this));
		GL_ARB_tessellation_shader = ext.contains("GL_ARB_tessellation_shader") && GL.checkExtension("GL_ARB_tessellation_shader", ARBTessellationShader.isAvailable(this));
		GL_ARB_texture_barrier = ext.contains("GL_ARB_texture_barrier") && GL.checkExtension("GL_ARB_texture_barrier", ARBTextureBarrier.isAvailable(this));
		GL_ARB_texture_border_clamp = ext.contains("GL_ARB_texture_border_clamp");
		GL_ARB_texture_buffer_object = ext.contains("GL_ARB_texture_buffer_object") && GL.checkExtension("GL_ARB_texture_buffer_object", ARBTextureBufferObject.isAvailable(this));
		GL_ARB_texture_buffer_object_rgb32 = ext.contains("GL_ARB_texture_buffer_object_rgb32");
		GL_ARB_texture_buffer_range = ext.contains("GL_ARB_texture_buffer_range") && GL.checkExtension("GL_ARB_texture_buffer_range", ARBTextureBufferRange.isAvailable(this, ext));
		GL_ARB_texture_compression = ext.contains("GL_ARB_texture_compression") && GL.checkExtension("GL_ARB_texture_compression", ARBTextureCompression.isAvailable(this));
		...
		GL_ARB_texture_multisample = ext.contains("GL_ARB_texture_multisample") && GL.checkExtension("GL_ARB_texture_multisample", ARBTextureMultisample.isAvailable(this));
		...
		GL_ARB_texture_storage = ext.contains("GL_ARB_texture_storage") && GL.checkExtension("GL_ARB_texture_storage", ARBTextureStorage.isAvailable(this, ext));
		GL_ARB_texture_storage_multisample = ext.contains("GL_ARB_texture_storage_multisample") && GL.checkExtension("GL_ARB_texture_storage_multisample", ARBTextureStorageMultisample.isAvailable(this, ext));
		GL_ARB_texture_swizzle = ext.contains("GL_ARB_texture_swizzle");
		GL_ARB_texture_view = ext.contains("GL_ARB_texture_view") && GL.checkExtension("GL_ARB_texture_view", ARBTextureView.isAvailable(this));
		GL_ARB_timer_query = ext.contains("GL_ARB_timer_query") && GL.checkExtension("GL_ARB_timer_query", ARBTimerQuery.isAvailable(this));
		GL_ARB_transform_feedback2 = ext.contains("GL_ARB_transform_feedback2") && GL.checkExtension("GL_ARB_transform_feedback2", ARBTransformFeedback2.isAvailable(this));
		GL_ARB_transform_feedback3 = ext.contains("GL_ARB_transform_feedback3") && GL.checkExtension("GL_ARB_transform_feedback3", ARBTransformFeedback3.isAvailable(this));
		GL_ARB_transform_feedback_instanced = ext.contains("GL_ARB_transform_feedback_instanced") && GL.checkExtension("GL_ARB_transform_feedback_instanced", ARBTransformFeedbackInstanced.isAvailable(this));
		GL_ARB_transform_feedback_overflow_query = ext.contains("GL_ARB_transform_feedback_overflow_query");
		GL_ARB_transpose_matrix = ext.contains("GL_ARB_transpose_matrix") && GL.checkExtension("GL_ARB_transpose_matrix", ARBTransposeMatrix.isAvailable(this));
		GL_ARB_uniform_buffer_object = ext.contains("GL_ARB_uniform_buffer_object") && GL.checkExtension("GL_ARB_uniform_buffer_object", ARBUniformBufferObject.isAvailable(this));
		GL_ARB_vertex_array_bgra = ext.contains("GL_ARB_vertex_array_bgra");
		GL_ARB_vertex_array_object = ext.contains("GL_ARB_vertex_array_object") && GL.checkExtension("GL_ARB_vertex_array_object", ARBVertexArrayObject.isAvailable(this));
		GL_ARB_vertex_attrib_64bit = ext.contains("GL_ARB_vertex_attrib_64bit") && GL.checkExtension("GL_ARB_vertex_attrib_64bit", ARBVertexAttrib64Bit.isAvailable(this, ext));
		GL_ARB_vertex_attrib_binding = ext.contains("GL_ARB_vertex_attrib_binding") && GL.checkExtension("GL_ARB_vertex_attrib_binding", ARBVertexAttribBinding.isAvailable(this, ext));
		GL_ARB_vertex_blend = ext.contains("GL_ARB_vertex_blend") && GL.checkExtension("GL_ARB_vertex_blend", ARBVertexBlend.isAvailable(this));
		GL_ARB_vertex_buffer_object = ext.contains("GL_ARB_vertex_buffer_object") && GL.checkExtension("GL_ARB_vertex_buffer_object", ARBVertexBufferObject.isAvailable(this));
		GL_ARB_vertex_program = ext.contains("GL_ARB_vertex_program") && GL.checkExtension("GL_ARB_vertex_program", ARBVertexProgram.isAvailable(this));
		GL_ARB_vertex_shader = ext.contains("GL_ARB_vertex_shader") && GL.checkExtension("GL_ARB_vertex_shader", ARBVertexShader.isAvailable(this));
		GL_ARB_vertex_type_10f_11f_11f_rev = ext.contains("GL_ARB_vertex_type_10f_11f_11f_rev");
		GL_ARB_vertex_type_2_10_10_10_rev = ext.contains("GL_ARB_vertex_type_2_10_10_10_rev") && GL.checkExtension("GL_ARB_vertex_type_2_10_10_10_rev", ARBVertexType2_10_10_10_REV.isAvailable(this, fc));
		GL_ARB_viewport_array = ext.contains("GL_ARB_viewport_array") && GL.checkExtension("GL_ARB_viewport_array", ARBViewportArray.isAvailable(this));
		GL_ARB_window_pos = ext.contains("GL_ARB_window_pos") && GL.checkExtension("GL_ARB_window_pos", ARBWindowPos.isAvailable(this));
		...
		CGL = ext.contains("CGL") && GL.checkExtension("CGL", org.lwjgl.opengl.CGL.isAvailable(this));
		GL_EXT_422_pixels = ext.contains("GL_EXT_422_pixels");
		GL_EXT_abgr = ext.contains("GL_EXT_abgr");
		GL_EXT_bgra = ext.contains("GL_EXT_bgra");
		GL_EXT_bindable_uniform = ext.contains("GL_EXT_bindable_uniform") && GL.checkExtension("GL_EXT_bindable_uniform", EXTBindableUniform.isAvailable(this));
		GL_EXT_blend_color = ext.contains("GL_EXT_blend_color") && GL.checkExtension("GL_EXT_blend_color", EXTBlendColor.isAvailable(this));
		GL_EXT_blend_equation_separate = ext.contains("GL_EXT_blend_equation_separate") && GL.checkExtension("GL_EXT_blend_equation_separate", EXTBlendEquationSeparate.isAvailable(this));
		GL_EXT_blend_func_separate = ext.contains("GL_EXT_blend_func_separate") && GL.checkExtension("GL_EXT_blend_func_separate", EXTBlendFuncSeparate.isAvailable(this));
		GL_EXT_blend_minmax = ext.contains("GL_EXT_blend_minmax") && GL.checkExtension("GL_EXT_blend_minmax", EXTBlendMinmax.isAvailable(this));
		GL_EXT_blend_subtract = ext.contains("GL_EXT_blend_subtract");
		GL_EXT_clip_volume_hint = ext.contains("GL_EXT_clip_volume_hint");
		GL_EXT_compiled_vertex_array = ext.contains("GL_EXT_compiled_vertex_array") && GL.checkExtension("GL_EXT_compiled_vertex_array", EXTCompiledVertexArray.isAvailable(this));
		GL_EXT_debug_label = ext.contains("GL_EXT_debug_label") && GL.checkExtension("GL_EXT_debug_label", EXTDebugLabel.isAvailable(this));
		GL_EXT_debug_marker = ext.contains("GL_EXT_debug_marker") && GL.checkExtension("GL_EXT_debug_marker", EXTDebugMarker.isAvailable(this));
		GL_EXT_depth_bounds_test = ext.contains("GL_EXT_depth_bounds_test") && GL.checkExtension("GL_EXT_depth_bounds_test", EXTDepthBoundsTest.isAvailable(this));
		GL_EXT_direct_state_access = ext.contains("GL_EXT_direct_state_access") && GL.checkExtension("GL_EXT_direct_state_access", EXTDirectStateAccess.isAvailable(this, ext));
		GL_EXT_draw_buffers2 = ext.contains("GL_EXT_draw_buffers2") && GL.checkExtension("GL_EXT_draw_buffers2", EXTDrawBuffers2.isAvailable(this));
		GL_EXT_draw_instanced = ext.contains("GL_EXT_draw_instanced") && GL.checkExtension("GL_EXT_draw_instanced", EXTDrawInstanced.isAvailable(this));
		GL_EXT_framebuffer_blit = ext.contains("GL_EXT_framebuffer_blit") && GL.checkExtension("GL_EXT_framebuffer_blit", EXTFramebufferBlit.isAvailable(this));
		GL_EXT_framebuffer_multisample = ext.contains("GL_EXT_framebuffer_multisample") && GL.checkExtension("GL_EXT_framebuffer_multisample", EXTFramebufferMultisample.isAvailable(this));
		GL_EXT_framebuffer_multisample_blit_scaled = ext.contains("GL_EXT_framebuffer_multisample_blit_scaled");
		GL_EXT_framebuffer_object = ext.contains("GL_EXT_framebuffer_object") && GL.checkExtension("GL_EXT_framebuffer_object", EXTFramebufferObject.isAvailable(this));
		GL_EXT_framebuffer_sRGB = ext.contains("GL_EXT_framebuffer_sRGB");
		GL_EXT_geometry_shader4 = ext.contains("GL_EXT_geometry_shader4") && GL.checkExtension("GL_EXT_geometry_shader4", EXTGeometryShader4.isAvailable(this));
		GL_EXT_gpu_program_parameters = ext.contains("GL_EXT_gpu_program_parameters") && GL.checkExtension("GL_EXT_gpu_program_parameters", EXTGPUProgramParameters.isAvailable(this));
		GL_EXT_gpu_shader4 = ext.contains("GL_EXT_gpu_shader4") && GL.checkExtension("GL_EXT_gpu_shader4", EXTGPUShader4.isAvailable(this));
		...
		GL_EXT_point_parameters = ext.contains("GL_EXT_point_parameters") && GL.checkExtension("GL_EXT_point_parameters", EXTPointParameters.isAvailable(this));
		GL_EXT_polygon_offset_clamp = ext.contains("GL_EXT_polygon_offset_clamp") && GL.checkExtension("GL_EXT_polygon_offset_clamp", EXTPolygonOffsetClamp.isAvailable(this));
		GL_EXT_post_depth_coverage = ext.contains("GL_EXT_post_depth_coverage");
		GL_EXT_provoking_vertex = ext.contains("GL_EXT_provoking_vertex") && GL.checkExtension("GL_EXT_provoking_vertex", EXTProvokingVertex.isAvailable(this));
		GL_EXT_raster_multisample = ext.contains("GL_EXT_raster_multisample") && GL.checkExtension("GL_EXT_raster_multisample", EXTRasterMultisample.isAvailable(this));
		GL_EXT_secondary_color = ext.contains("GL_EXT_secondary_color") && GL.checkExtension("GL_EXT_secondary_color", EXTSecondaryColor.isAvailable(this));
		GL_EXT_separate_shader_objects = ext.contains("GL_EXT_separate_shader_objects") && GL.checkExtension("GL_EXT_separate_shader_objects", EXTSeparateShaderObjects.isAvailable(this));
		GL_EXT_shader_image_load_formatted = ext.contains("GL_EXT_shader_image_load_formatted");
		GL_EXT_shader_image_load_store = ext.contains("GL_EXT_shader_image_load_store") && GL.checkExtension("GL_EXT_shader_image_load_store", EXTShaderImageLoadStore.isAvailable(this));
		...
		GL_EXT_stencil_clear_tag = ext.contains("GL_EXT_stencil_clear_tag") && GL.checkExtension("GL_EXT_stencil_clear_tag", EXTStencilClearTag.isAvailable(this));
		GL_EXT_stencil_two_side = ext.contains("GL_EXT_stencil_two_side") && GL.checkExtension("GL_EXT_stencil_two_side", EXTStencilTwoSide.isAvailable(this));
		GL_EXT_stencil_wrap = ext.contains("GL_EXT_stencil_wrap");
		GL_EXT_texture_array = ext.contains("GL_EXT_texture_array") && GL.checkExtension("GL_EXT_texture_array", EXTTextureArray.isAvailable(this));
		GL_EXT_texture_buffer_object = ext.contains("GL_EXT_texture_buffer_object") && GL.checkExtension("GL_EXT_texture_buffer_object", EXTTextureBufferObject.isAvailable(this));
		...
		GL_EXT_texture_integer = ext.contains("GL_EXT_texture_integer") && GL.checkExtension("GL_EXT_texture_integer", EXTTextureInteger.isAvailable(this));
		...
		GL_EXT_timer_query = ext.contains("GL_EXT_timer_query") && GL.checkExtension("GL_EXT_timer_query", EXTTimerQuery.isAvailable(this));
		GL_EXT_transform_feedback = ext.contains("GL_EXT_transform_feedback") && GL.checkExtension("GL_EXT_transform_feedback", EXTTransformFeedback.isAvailable(this));
		GL_EXT_vertex_array_bgra = ext.contains("GL_EXT_vertex_array_bgra");
		GL_EXT_vertex_attrib_64bit = ext.contains("GL_EXT_vertex_attrib_64bit") && GL.checkExtension("GL_EXT_vertex_attrib_64bit", EXTVertexAttrib64bit.isAvailable(this, ext));
		GL_EXT_x11_sync_object = ext.contains("GL_EXT_x11_sync_object") && GL.checkExtension("GL_EXT_x11_sync_object", EXTX11SyncObject.isAvailable(this));
		GL_INTEL_fragment_shader_ordering = ext.contains("GL_INTEL_fragment_shader_ordering");
		GL_INTEL_framebuffer_CMAA = ext.contains("GL_INTEL_framebuffer_CMAA") && GL.checkExtension("GL_INTEL_framebuffer_CMAA", INTELFramebufferCMAA.isAvailable(this));
		GL_INTEL_map_texture = ext.contains("GL_INTEL_map_texture") && GL.checkExtension("GL_INTEL_map_texture", INTELMapTexture.isAvailable(this));
		GL_INTEL_performance_query = ext.contains("GL_INTEL_performance_query") && GL.checkExtension("GL_INTEL_performance_query", INTELPerformanceQuery.isAvailable(this));
		GL_KHR_blend_equation_advanced = ext.contains("GL_KHR_blend_equation_advanced") && GL.checkExtension("GL_KHR_blend_equation_advanced", KHRBlendEquationAdvanced.isAvailable(this));
		...
		GL_KHR_debug = ext.contains("GL_KHR_debug") && GL.checkExtension("GL_KHR_debug", KHRDebug.isAvailable(this));
		...
		GL_KHR_robustness = ext.contains("GL_KHR_robustness") && GL.checkExtension("GL_KHR_robustness", KHRRobustness.isAvailable(this));
		...
		GL_NV_bindless_multi_draw_indirect = ext.contains("GL_NV_bindless_multi_draw_indirect") && GL.checkExtension("GL_NV_bindless_multi_draw_indirect", NVBindlessMultiDrawIndirect.isAvailable(this));
		GL_NV_bindless_multi_draw_indirect_count = ext.contains("GL_NV_bindless_multi_draw_indirect_count") && GL.checkExtension("GL_NV_bindless_multi_draw_indirect_count", NVBindlessMultiDrawIndirectCount.isAvailable(this));
		GL_NV_bindless_texture = ext.contains("GL_NV_bindless_texture") && GL.checkExtension("GL_NV_bindless_texture", NVBindlessTexture.isAvailable(this));
		GL_NV_blend_equation_advanced = ext.contains("GL_NV_blend_equation_advanced") && GL.checkExtension("GL_NV_blend_equation_advanced", NVBlendEquationAdvanced.isAvailable(this));
		...
		GL_NV_command_list = ext.contains("GL_NV_command_list") && GL.checkExtension("GL_NV_command_list", NVCommandList.isAvailable(this));
		GL_NV_conditional_render = ext.contains("GL_NV_conditional_render") && GL.checkExtension("GL_NV_conditional_render", NVConditionalRender.isAvailable(this));
		GL_NV_conservative_raster = ext.contains("GL_NV_conservative_raster") && GL.checkExtension("GL_NV_conservative_raster", NVConservativeRaster.isAvailable(this));
		GL_NV_conservative_raster_dilate = ext.contains("GL_NV_conservative_raster_dilate") && GL.checkExtension("GL_NV_conservative_raster_dilate", NVConservativeRasterDilate.isAvailable(this));
		GL_NV_copy_depth_to_color = ext.contains("GL_NV_copy_depth_to_color");
		GL_NV_copy_image = ext.contains("GL_NV_copy_image") && GL.checkExtension("GL_NV_copy_image", NVCopyImage.isAvailable(this));
		GL_NV_deep_texture3D = ext.contains("GL_NV_deep_texture3D");
		GL_NV_depth_buffer_float = ext.contains("GL_NV_depth_buffer_float") && GL.checkExtension("GL_NV_depth_buffer_float", NVDepthBufferFloat.isAvailable(this));
		GL_NV_depth_clamp = ext.contains("GL_NV_depth_clamp");
		GL_NV_draw_texture = ext.contains("GL_NV_draw_texture") && GL.checkExtension("GL_NV_draw_texture", NVDrawTexture.isAvailable(this));
		GL_NV_explicit_multisample = ext.contains("GL_NV_explicit_multisample") && GL.checkExtension("GL_NV_explicit_multisample", NVExplicitMultisample.isAvailable(this));
		GL_NV_fence = ext.contains("GL_NV_fence") && GL.checkExtension("GL_NV_fence", NVFence.isAvailable(this));
		...
		GL_NV_fragment_coverage_to_color = ext.contains("GL_NV_fragment_coverage_to_color") && GL.checkExtension("GL_NV_fragment_coverage_to_color", NVFragmentCoverageToColor.isAvailable(this));
		...
		GL_NV_framebuffer_mixed_samples = ext.contains("GL_NV_framebuffer_mixed_samples") && GL.checkExtension("GL_NV_framebuffer_mixed_samples", NVFramebufferMixedSamples.isAvailable(this));
		GL_NV_framebuffer_multisample_coverage = ext.contains("GL_NV_framebuffer_multisample_coverage") && GL.checkExtension("GL_NV_framebuffer_multisample_coverage", NVFramebufferMultisampleCoverage.isAvailable(this));
		...
		GL_NV_gpu_shader5 = ext.contains("GL_NV_gpu_shader5") && GL.checkExtension("GL_NV_gpu_shader5", NVGPUShader5.isAvailable(this));
		GL_NV_half_float = ext.contains("GL_NV_half_float") && GL.checkExtension("GL_NV_half_float", NVHalfFloat.isAvailable(this, ext));
		GL_NV_internalformat_sample_query = ext.contains("GL_NV_internalformat_sample_query") && GL.checkExtension("GL_NV_internalformat_sample_query", NVInternalformatSampleQuery.isAvailable(this));
		...
		GL_NV_path_rendering = ext.contains("GL_NV_path_rendering") && GL.checkExtension("GL_NV_path_rendering", NVPathRendering.isAvailable(this));
		GL_NV_path_rendering_shared_edge = ext.contains("GL_NV_path_rendering_shared_edge");
		GL_NV_pixel_data_range = ext.contains("GL_NV_pixel_data_range") && GL.checkExtension("GL_NV_pixel_data_range", NVPixelDataRange.isAvailable(this));
		GL_NV_point_sprite = ext.contains("GL_NV_point_sprite") && GL.checkExtension("GL_NV_point_sprite", NVPointSprite.isAvailable(this));
		GL_NV_primitive_restart = ext.contains("GL_NV_primitive_restart") && GL.checkExtension("GL_NV_primitive_restart", NVPrimitiveRestart.isAvailable(this));
		GL_NV_sample_locations = ext.contains("GL_NV_sample_locations") && GL.checkExtension("GL_NV_sample_locations", NVSampleLocations.isAvailable(this));
		...
		GL_NV_shader_buffer_load = ext.contains("GL_NV_shader_buffer_load") && GL.checkExtension("GL_NV_shader_buffer_load", NVShaderBufferLoad.isAvailable(this));
		...
		GL_NV_texture_barrier = ext.contains("GL_NV_texture_barrier") && GL.checkExtension("GL_NV_texture_barrier", NVTextureBarrier.isAvailable(this));
		GL_NV_texture_compression_vtc = ext.contains("GL_NV_texture_compression_vtc");
		GL_NV_texture_multisample = ext.contains("GL_NV_texture_multisample") && GL.checkExtension("GL_NV_texture_multisample", NVTextureMultisample.isAvailable(this));
		GL_NV_transform_feedback = ext.contains("GL_NV_transform_feedback") && GL.checkExtension("GL_NV_transform_feedback", NVTransformFeedback.isAvailable(this));
		GL_NV_transform_feedback2 = ext.contains("GL_NV_transform_feedback2") && GL.checkExtension("GL_NV_transform_feedback2", NVTransformFeedback2.isAvailable(this));
		GL_NV_uniform_buffer_unified_memory = ext.contains("GL_NV_uniform_buffer_unified_memory");
		GL_NV_vertex_array_range = ext.contains("GL_NV_vertex_array_range") && GL.checkExtension("GL_NV_vertex_array_range", NVVertexArrayRange.isAvailable(this));
		GL_NV_vertex_array_range2 = ext.contains("GL_NV_vertex_array_range2");
		GL_NV_vertex_attrib_integer_64bit = ext.contains("GL_NV_vertex_attrib_integer_64bit") && GL.checkExtension("GL_NV_vertex_attrib_integer_64bit", NVVertexAttribInteger64bit.isAvailable(this, ext));
		GL_NV_vertex_buffer_unified_memory = ext.contains("GL_NV_vertex_buffer_unified_memory") && GL.checkExtension("GL_NV_vertex_buffer_unified_memory", NVVertexBufferUnifiedMemory.isAvailable(this));
		GL_NV_viewport_array2 = ext.contains("GL_NV_viewport_array2");
		GL_NVX_conditional_render = ext.contains("GL_NVX_conditional_render") && GL.checkExtension("GL_NVX_conditional_render", NVXConditionalRender.isAvailable(this));
		GL_NVX_gpu_memory_info = ext.contains("GL_NVX_gpu_memory_info");
		GL_OVR_multiview = ext.contains("GL_OVR_multiview") && GL.checkExtension("GL_OVR_multiview", OVRMultiview.isAvailable(this));
		GL_OVR_multiview2 = ext.contains("GL_OVR_multiview2");
		WGL = ext.contains("WGL") && GL.checkExtension("WGL", org.lwjgl.opengl.WGL.isAvailable(this));
		WGL_AMD_gpu_association = ext.contains("WGL_AMD_gpu_association") && GL.checkExtension("WGL_AMD_gpu_association", WGLAMDGPUAssociation.isAvailable(this, ext));
		WGL_ARB_buffer_region = ext.contains("WGL_ARB_buffer_region") && GL.checkExtension("WGL_ARB_buffer_region", WGLARBBufferRegion.isAvailable(this));
		WGL_ARB_context_flush_control = ext.contains("WGL_ARB_context_flush_control");
		WGL_ARB_create_context = ext.contains("WGL_ARB_create_context") && GL.checkExtension("WGL_ARB_create_context", WGLARBCreateContext.isAvailable(this));
		...
		WGL_ARB_extensions_string = ext.contains("WGL_ARB_extensions_string") && GL.checkExtension("WGL_ARB_extensions_string", WGLARBExtensionsString.isAvailable(this));
		WGL_ARB_framebuffer_sRGB = ext.contains("WGL_ARB_framebuffer_sRGB");
		WGL_ARB_make_current_read = ext.contains("WGL_ARB_make_current_read") && GL.checkExtension("WGL_ARB_make_current_read", WGLARBMakeCurrentRead.isAvailable(this));
		WGL_ARB_multisample = ext.contains("WGL_ARB_multisample");
		WGL_ARB_pbuffer = ext.contains("WGL_ARB_pbuffer") && GL.checkExtension("WGL_ARB_pbuffer", WGLARBPbuffer.isAvailable(this));
		WGL_ARB_pixel_format = ext.contains("WGL_ARB_pixel_format") && GL.checkExtension("WGL_ARB_pixel_format", WGLARBPixelFormat.isAvailable(this));
		WGL_ARB_pixel_format_float = ext.contains("WGL_ARB_pixel_format_float");
		WGL_ARB_render_texture = ext.contains("WGL_ARB_render_texture") && GL.checkExtension("WGL_ARB_render_texture", WGLARBRenderTexture.isAvailable(this));
		...
		WGL_EXT_extensions_string = ext.contains("WGL_EXT_extensions_string") && GL.checkExtension("WGL_EXT_extensions_string", WGLEXTExtensionsString.isAvailable(this));
		...
		WGL_EXT_swap_control = ext.contains("WGL_EXT_swap_control") && GL.checkExtension("WGL_EXT_swap_control", WGLEXTSwapControl.isAvailable(this));
		WGL_EXT_swap_control_tear = ext.contains("WGL_EXT_swap_control_tear");
		WGL_NV_copy_image = ext.contains("WGL_NV_copy_image") && GL.checkExtension("WGL_NV_copy_image", WGLNVCopyImage.isAvailable(this));
		WGL_NV_delay_before_swap = ext.contains("WGL_NV_delay_before_swap") && GL.checkExtension("WGL_NV_delay_before_swap", WGLNVDelayBeforeSwap.isAvailable(this));
		WGL_NV_DX_interop = ext.contains("WGL_NV_DX_interop") && GL.checkExtension("WGL_NV_DX_interop", WGLNVDXInterop.isAvailable(this));
		WGL_NV_DX_interop2 = ext.contains("WGL_NV_DX_interop2");
		WGL_NV_float_buffer = ext.contains("WGL_NV_float_buffer");
		WGL_NV_gpu_affinity = ext.contains("WGL_NV_gpu_affinity") && GL.checkExtension("WGL_NV_gpu_affinity", WGLNVGPUAffinity.isAvailable(this));
		...
		WGL_NV_swap_group = ext.contains("WGL_NV_swap_group") && GL.checkExtension("WGL_NV_swap_group", WGLNVSwapGroup.isAvailable(this));
		WGL_NV_vertex_array_range = ext.contains("WGL_NV_vertex_array_range") && GL.checkExtension("WGL_NV_vertex_array_range", WGLNVVertexArrayRange.isAvailable(this));
	}

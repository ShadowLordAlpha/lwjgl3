...
public class WGLARBPbuffer {
	...
	public static long nwglCreatePbufferARB(long hdc, int pixelFormat, int width, int height, long attribList) {
		long __functionAddress = GL.getCapabilities().wglCreatePbufferARB;
		if ( CHECKS ) {
	...
	public static long wglGetPbufferDCARB(long pbuffer) {
		long __functionAddress = GL.getCapabilities().wglGetPbufferDCARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
	...
	public static int wglReleasePbufferDCARB(long pbuffer, long hdc) {
		long __functionAddress = GL.getCapabilities().wglReleasePbufferDCARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
			checkPointer(hdc);
	...
	public static int wglDestroyPbufferARB(long pbuffer) {
		long __functionAddress = GL.getCapabilities().wglDestroyPbufferARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}
	...
	public static int nwglQueryPbufferARB(long pbuffer, int attribute, long value) {
		long __functionAddress = GL.getCapabilities().wglQueryPbufferARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}

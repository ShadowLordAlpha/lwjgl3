...
public class WGLARBRenderTexture {
	...
	public static int wglBindTexImageARB(long pbuffer, int buffer) {
		long __functionAddress = GL.getCapabilities().wglBindTexImageARB;
		if ( CHECKS ) {
	...
	public static int wglReleaseTexImageARB(long pbuffer, int buffer) {
		long __functionAddress = GL.getCapabilities().wglReleaseTexImageARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}
	...
	public static int nwglSetPbufferAttribARB(long pbuffer, long attribList) {
		long __functionAddress = GL.getCapabilities().wglSetPbufferAttribARB;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(pbuffer);
		}

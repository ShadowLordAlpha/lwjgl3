...
public class GLXAMDGPUAssociation {
	...
	public static void glXBlitContextFramebufferAMD(long dstCtx, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, int mask, int filter) {
		long __functionAddress = GL.getCapabilities().glXBlitContextFramebufferAMD;
		if ( CHECKS ) {
	...
	public static long glXCreateAssociatedContextAMD(int id, long share_list) {
		long __functionAddress = GL.getCapabilities().glXCreateAssociatedContextAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
	...
	public static long nglXCreateAssociatedContextAttribsAMD(int id, long share_context, long attribList) {
		long __functionAddress = GL.getCapabilities().glXCreateAssociatedContextAttribsAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
	...
	public static int glXDeleteAssociatedContextAMD(long ctx) {
		long __functionAddress = GL.getCapabilities().glXDeleteAssociatedContextAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static int glXGetContextGPUIDAMD(long ctx) {
		long __functionAddress = GL.getCapabilities().glXGetContextGPUIDAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}
	...
	public static long glXGetCurrentAssociatedContextAMD() {
		long __functionAddress = GL.getCapabilities().glXGetCurrentAssociatedContextAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int glXGetGPUIDsAMD(int maxCount, int ids) {
		long __functionAddress = GL.getCapabilities().glXGetGPUIDsAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int nglXGetGPUInfoAMD(int id, int property, int dataType, int size, long data) {
		long __functionAddress = GL.getCapabilities().glXGetGPUInfoAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int glXMakeAssociatedContextCurrentAMD(long ctx) {
		long __functionAddress = GL.getCapabilities().glXMakeAssociatedContextCurrentAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(ctx);
		}

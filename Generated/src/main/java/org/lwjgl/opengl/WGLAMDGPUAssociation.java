...
public class WGLAMDGPUAssociation {
	...
	static boolean isAvailable(GLCapabilities caps, java.util.Set<String> ext) {
		return checkFunctions(
			...
			caps.wglGetCurrentAssociatedContextAMD, ext.contains("GL_EXT_framebuffer_blit") ? caps.wglBlitContextFramebufferAMD : -1L
		);
	}
	...
	public static int nwglGetGPUIDsAMD(int maxCount, long ids) {
		long __functionAddress = GL.getCapabilities().wglGetGPUIDsAMD;
		if ( CHECKS )
	...
	public static int nwglGetGPUInfoAMD(int id, int property, int dataType, int size, long data) {
		long __functionAddress = GL.getCapabilities().wglGetGPUInfoAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int wglGetContextGPUIDAMD(long hglrc) {
		long __functionAddress = GL.getCapabilities().wglGetContextGPUIDAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(hglrc);
		}
	...
	public static long wglCreateAssociatedContextAMD(int id) {
		long __functionAddress = GL.getCapabilities().wglCreateAssociatedContextAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static long nwglCreateAssociatedContextAttribsAMD(int id, long shareContext, long attribList) {
		long __functionAddress = GL.getCapabilities().wglCreateAssociatedContextAttribsAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static int wglDeleteAssociatedContextAMD(long hglrc) {
		long __functionAddress = GL.getCapabilities().wglDeleteAssociatedContextAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(hglrc);
		}
	...
	public static int wglMakeAssociatedContextCurrentAMD(long hglrc) {
		long __functionAddress = GL.getCapabilities().wglMakeAssociatedContextCurrentAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(hglrc);
		}
	...
	public static long wglGetCurrentAssociatedContextAMD() {
		long __functionAddress = GL.getCapabilities().wglGetCurrentAssociatedContextAMD;
		if ( CHECKS )
			checkFunctionAddress(__functionAddress);
	...
	public static void wglBlitContextFramebufferAMD(long dstCtx, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, int mask, int filter) {
		long __functionAddress = GL.getCapabilities().wglBlitContextFramebufferAMD;
		if ( CHECKS ) {
			checkFunctionAddress(__functionAddress);
			checkPointer(dstCtx);
		}
